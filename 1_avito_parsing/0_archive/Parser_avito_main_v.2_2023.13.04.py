...
url = "https://www.avito.ru/sankt-peterburg/kvartiry/prodam/2-komnatnye/vtorichka-ASgBAQICAUSSA8YQAkDmBxSMUsoIFIJZ" # + "?p=1"
...
def main():
    ...
    # получаем итоговые списки urls и prices и параметров с данными со всех страниц
    today = datetime.datetime.today().strftime('%d.%m.%Y')
    file_path = f'/Users/dmitrijdolgopolov/Documents/1_study_python/projects/1_avito_parsing/flats_from_avito/page_codes/Page_code_{today}.txt'
